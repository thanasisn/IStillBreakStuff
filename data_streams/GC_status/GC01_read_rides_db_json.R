...
Sys.setenv(TZ = "UTC")
tic <- Sys.time()
Script.Name <- "~/CODE/data_streams/GC_status/GC01_read_rides_db_json.R"
...
require(fANCOVA,    quietly = TRUE, warn.conflicts = FALSE)
...
if (
  ...
  file.mtime(storagefl) < file.mtime(gccache)
) {
