...
if (!file.exists(storagefl) || file.mtime(gccache) > file.mtime(storagefl)) {
    ...
    wecare <- c(
        ...
        grep(".W.",              names(a), value = TRUE, ignore.case = TRUE),
        ...
        grep(".sustained.Time",  names(a), value = TRUE, ignore.case = TRUE),
        ...
        grep("Recovery.time",    names(a), value = TRUE, ignore.case = TRUE),
        ...
        grep("daniels.points",   names(a), value = TRUE, ignore.case = TRUE),
        ...
        grep("heart.rate",       names(a), value = TRUE, ignore.case = TRUE),
